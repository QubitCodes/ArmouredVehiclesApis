...
/**
 * UserProfile1 Attributes Interface (LEGACY BACKUP)
 * Matches the user_profiles_1 table schema
 */
export interface UserProfile1Attributes {
    id: string;
    user_id: string;
...
export interface UserProfile1CreationAttributes extends Optional<UserProfile1Attributes, 'id' | 'current_step' | 'onboarding_status' | 'created_at' | 'updated_at'> { }

/**
 * UserProfile1 Model (LEGACY BACKUP)
 * Points to the user_profiles_1 table
 */
export class UserProfile1 extends Model<UserProfile1Attributes, UserProfile1CreationAttributes> implements UserProfile1Attributes {
