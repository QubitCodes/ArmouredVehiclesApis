	...
	async step0(req: NextRequest) {
		try {
			...
			const { 
                ...
                businessLicenseUrl // Now passed as URL string from frontend
            } = body;
	...
	async step3(req: NextRequest) {
		try {
            ...
            const updates: any = {
                ...
                procurement_purpose: procurementPurpose,
